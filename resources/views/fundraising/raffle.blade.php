...
@section('page_title', strtr('Розіграш для донаторів :fundraising - donater.com.ua', [':fundraising' => $fundraising->getName()]))
@section('page_description', strtr('Розіграш для донаторів :fundraising - donater.com.ua', [':fundraising' => $fundraising->getName()]))
@push('head-scripts')
...
@section('content')
    <div class="container px-4 py-5">
        <h2 class="pb-2 border-bottom"><a href="{{ route('fundraising.all') }}" class=""><i class="bi bi-arrow-left"></i></a>
            Розіграш для донаторів {{ $fundraising->getName() }}
        </h2>
        <div class="row">
