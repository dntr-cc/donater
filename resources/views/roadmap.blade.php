                        ...
                        <ul class="timeline-with-icons">
                            ...
                            <li class="timeline-item mb-5">
                                ...
                                <p class="text-muted">
                                    ...
                                    всі пов'язані блоки в доступності одного кліку - підписатися на волонтера в будь-якому
                            ...
                            <li class="timeline-item mb-5">
                                ...
                                <ul>
                                    <li>Додана анлітика донатера (публічна). Додана анлітика по всім донатам користувачів в загальний розділ аналітики</li>
                                    <li>Видалено неактуальні налаштування</li>
                                    <li>Пофікшені всі баги з розгортанням блоків</li>
                                    <li>Пофікшен баг авторизації</li>
                                    <li>Додано налаштування "При відкритті профілів всі блоки окрім посилань будуть розгорнуті"</li>
                                    <li>Додано унікальні коди при донаті з нагадування. Це перший крок до прорахунку "надійності донатера". Це дозволить відслідковувати донати по підпісці, які в майбутньому будуть використані в математичній моделі "коли закриється мій збір" в функціоналі волонтера</li>
                                    <li>Пофікшені баги коли на сторінці кілька зборів, та волонтер натискає на кнопки призи чи коротке посилання окремого збору</li>
                                </ul>
                            </li>
                            <li class="timeline-item mb-5">
                                <span class="timeline-icon">
                                ...
                                <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>Розробити модель оцінки "серійний донатер". Регулярні донати це те, куди
                                            ...
                                            Більше шансів що інші донатери долучаться до зборів цього волонтеру
                                        </li>
                                    </ul>
