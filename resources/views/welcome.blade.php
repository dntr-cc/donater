    ...
    <div class="container my-5">
        <section class="jumbotron text-center">
            <div class="container">
                ...
                @if(!auth()->user())
                    ...
                    <p>
                        <a id="enableBot" target="_blank"
                           href="{{ config('telegram.bots.donater-bot.url') }}?start={{ session()->get(LoginController::LOGIN_HASH, '') }}"
                ...
                <p class="lead text-muted">
                    Якщо ви донатер/ка - підписуйтеся на свого волонтера/ку (спитайте посилання на сторінку у
                    волонтера/ки),
                    щоб задати розклад. Якщо вашого волонтера/ки нема на сайті, запросіть його/її/їх своїм кодом
                    донатера,
                ...
                <p class="lead text-muted">
                    ...
                    надходженням коштів для волонтерів. Наразі ця аналітика мінімальна, але з часом це стане вашим
                    інструментом
