...
Route::get('/fundraisings/{fundraising}/restore', [App\Http\Controllers\FundraisingController::class, 'restore'])->name('fundraisings.restore')->middleware(['super']);
Route::get('/fundraisings/{fundraising}/delete', [App\Http\Controllers\FundraisingController::class, 'destroy'])->name('fundraisings.delete')->middleware(['super']);
